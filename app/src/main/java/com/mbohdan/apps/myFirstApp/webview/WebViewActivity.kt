package com.mbohdan.apps.myFirstApp.webview
        ...
        */
        ...
        web_view.webViewClient = object: WebViewClient(){
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                // Do something
                toast("Page loading. ${view.getUrl()}")
            ...
            override fun onPageFinished(view: WebView, url: String) {
                ...
                if(view.url.contains("error=501")){
                    toast("Operation has been CANCELLED")
                    finish()
                } else if(view.url.contains("paid=true")){
                    toast("Gratulation!")
                    //TODO: user fetch from server
                    finish()
                }
                // Enable disable back forward button
                button_back.isEnabled = web_view.canGoBack()
